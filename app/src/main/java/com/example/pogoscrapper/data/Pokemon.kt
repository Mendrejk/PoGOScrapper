...
data class Pokemon(
    ...
    @ColumnInfo(name = "Great League Fast Move") val fastMoveGL: String?,
    @ColumnInfo(name = "Ultra League Fast Move") val fastMoveUL: String?,
    @ColumnInfo(name = "Master League Fast Move") val fastMoveML: String?,
